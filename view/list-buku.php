            ...
            <div class="row">
              <?php foreach ($listBukuPeminjaman as $data) : ?>
                <div class="col-lg-3 col-md-6 mt-5">
                  <div class="kartu">
                    <div class="d-flex m-auto"  style="width: 100%; height :200px; background-image:url('<?php echo $data['gambar'] ?>'); background-position: center; background-size: cover;" alt=""></div>
