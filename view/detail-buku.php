  ...
  if(isset($_GET['id'])) {
    ...
    if(isset($_POST['tambahKoleksi'])) {
      ...
      if($tambahKoleksi === 'berhasil') {
        ...
        $_SESSION['notifikasiBerhasil'] = 'gagal gagal koleksi'; 
      }
        ...
        <div class="modal-content">
          ...
          <form method="POST">
              ...
              <div class="mb-3">
                  ...
                  <input type="date" disabled class="form-control" id="tanggalPeminjaman" aria-describedby="emailHelp" value="<?= date('Y-m-d', strtotime('+7 hours')) ?>">
              </div>
              <div class="mb-3">
                  <label for="tanggalPengembalian" class="form-label">Tanggal Pengembalian</label>
                  <input type="date" class="form-control" id="tanggalPengembalian" min="" onchange="setMinDate()">
              </div>
      ...
      <div class="row">
        <div class="col-lg-5">
          <div class="gambar-detail">
            <img src="../assets/buku_detail.png" alt="" />
          </div>
        </div>
        <div class="col-lg-7 pb-4">
          ...
          <div class="mb-4">
            <a href="" style="text-decoration:none; padding : 7px 20px; border-radius:25px; background-color:#00b56a; color:white;">Berikan Ulasan</a>
          </div>
