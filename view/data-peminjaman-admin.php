    ...
    <div class="section-list">
        <div class="row">
            ...
            <div class="col-lg-10 col-md-11 kanan-dasboard">
                ...
                <!-- end nav -->
                <div class="container">
                    <div class="judul text-center mt-5 mb-5"><h3>Daftar Peminjaman Buku</h3></div>
                        ...
                        <tbody>
                            ...
                            <?php foreach($data as $row): ?>
                                <tr>
                                    ...
                                    <td data-label="Status Peminjaman"><p style="background-color:#00CC39; border-radius:40px; color:white; margin-bottom:5px;"><?= $row['StatusPeminjaman'] ?></p></td>
